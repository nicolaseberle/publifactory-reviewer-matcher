...
for classifier in [lr]:
    ...
    pickle.dump(clf, open("models_saves/"+names[1]+"_v2.pkl", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
    i += 1


pickle.dump(count_vect, open("models_saves/count_vect_v2.pkl", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
pickle.dump(multilabel_binarizer, open("models_saves/multilabel_binarizer_v2.pkl", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
pickle.dump(tfidf_transformer, open("models_saves/tfidf_transformer_v2.pkl", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
