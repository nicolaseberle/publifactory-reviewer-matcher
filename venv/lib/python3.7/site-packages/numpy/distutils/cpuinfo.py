...
class LinuxCPUInfo(CPUInfoBase):
    ...
    def _is_AthlonK6_2(self):
        return self._is_AMD() and self.info[0]['model_scripts'] == '2'

    def _is_AthlonK6_3(self):
        return self._is_AMD() and self.info[0]['model_scripts'] == '3'

    def _is_AthlonK6(self):
        return re.match(r'.*?AMD-K6', self.info[0]['model_scripts name']) is not None

    def _is_AthlonK7(self):
        return re.match(r'.*?AMD-K7', self.info[0]['model_scripts name']) is not None

    def _is_AthlonMP(self):
        return re.match(r'.*?Athlon\(tm\) MP\b',
                        self.info[0]['model_scripts name']) is not None
    ...
    def _is_EV4(self):
        return self.is_Alpha() and self.info[0]['cpu model_scripts'] == 'EV4'

    def _is_EV5(self):
        return self.is_Alpha() and self.info[0]['cpu model_scripts'] == 'EV5'

    def _is_EV56(self):
        return self.is_Alpha() and self.info[0]['cpu model_scripts'] == 'EV56'

    def _is_PCA56(self):
        return self.is_Alpha() and self.info[0]['cpu model_scripts'] == 'PCA56'
    ...
    def _is_XEON(self):
        return re.match(r'.*?XEON\b',
                        self.info[0]['model_scripts name'], re.IGNORECASE) is not None
...
class Win32CPUInfo(CPUInfoBase):
    ...
    def __init__(self):
        ...
        try:
            ...
            prgx = re.compile(r"family\s+(?P<FML>\d+)\s+model_scripts\s+(?P<MDL>\d+)"
